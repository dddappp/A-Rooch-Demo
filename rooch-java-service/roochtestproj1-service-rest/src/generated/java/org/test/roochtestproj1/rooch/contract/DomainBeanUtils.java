...
import org.test.roochtestproj1.domain.article.AbstractArticleEvent;
import org.test.roochtestproj1.rooch.contract.article.ArticleCreated;
import org.test.roochtestproj1.rooch.contract.article.ReferenceAdded;
import org.test.roochtestproj1.rooch.contract.article.ReferenceUpdated;
import org.test.roochtestproj1.rooch.contract.article.ReferenceRemoved;
import org.test.roochtestproj1.domain.tag.AbstractTagEvent;
import org.test.roochtestproj1.rooch.contract.tag.TagCreated;
import org.test.roochtestproj1.domain.daysummary.AbstractDaySummaryEvent;
import org.test.roochtestproj1.rooch.contract.daysummary.DaySummaryCreated;
import org.test.roochtestproj1.domain.order.AbstractOrderEvent;
import org.test.roochtestproj1.rooch.contract.order.OrderCreated;
import org.test.roochtestproj1.rooch.contract.order.OrderItemRemoved;
import org.test.roochtestproj1.rooch.contract.order.OrderItemQuantityUpdated;
import org.test.roochtestproj1.rooch.contract.order.OrderEstimatedShipDateUpdated;
import org.test.roochtestproj1.rooch.contract.order.OrderShipGroupAdded;
import org.test.roochtestproj1.rooch.contract.order.OrderItemShipGroupAssocSubitemAdded;
...
import org.test.roochtestproj1.domain.product.AbstractProductEvent;
import org.test.roochtestproj1.rooch.contract.product.ProductCreated;
...
public class DomainBeanUtils {
    ...
    public static org.test.roochtestproj1.domain.Day toDay(Day contractDay) {
        if (contractDay == null) {
            return null;
        }
        org.test.roochtestproj1.domain.Day day = new org.test.roochtestproj1.domain.Day();
    ...
    public static org.test.roochtestproj1.domain.Month toMonth(Month contractMonth) {
        if (contractMonth == null) {
            return null;
        }
        org.test.roochtestproj1.domain.Month month = new org.test.roochtestproj1.domain.Month();
    ...
    public static org.test.roochtestproj1.domain.ReferenceVO toReferenceVO(ReferenceVO contractReferenceVO) {
        if (contractReferenceVO == null) {
            return null;
        }
        org.test.roochtestproj1.domain.ReferenceVO referenceVO = new org.test.roochtestproj1.domain.ReferenceVO();
    ...
    public static org.test.roochtestproj1.domain.Year toYear(Year contractYear) {
        if (contractYear == null) {
            return null;
        }
        org.test.roochtestproj1.domain.Year year = new org.test.roochtestproj1.domain.Year();
    ...
    public static AbstractArticleEvent.ArticleCreated toArticleCreated(AnnotatedEventView<ArticleCreated> eventEnvelope) {
        ...
        articleCreated.setReferences(java.util.Arrays.stream(contractEvent.getReferences()).map(DomainBeanUtils::toReferenceVO).toArray(org.test.roochtestproj1.domain.ReferenceVO[]::new));
    ...
    public static org.test.roochtestproj1.rooch.contract.persistence.ReferenceTableItemAdded toPersistenceReferenceTableItemAdded(AnnotatedEventView<ReferenceTableItemAdded> eventEnvelope) {
        ReferenceTableItemAdded contractEvent = eventEnvelope.getParsedEventData().getValue();
        org.test.roochtestproj1.domain.article.ArticleReferenceId id = new org.test.roochtestproj1.domain.article.ArticleReferenceId(contractEvent.getArticleId(), contractEvent.getReferenceNumber());
        org.test.roochtestproj1.rooch.contract.persistence.ReferenceTableItemAdded e = new org.test.roochtestproj1.rooch.contract.persistence.ReferenceTableItemAdded();
        e.setArticleReferenceId(id);
        setRoochEventProperties(e, eventEnvelope);
        return e;
    }

    public static org.test.roochtestproj1.rooch.contract.persistence.OrderItemTableItemAdded toPersistenceOrderItemTableItemAdded(AnnotatedEventView<OrderItemTableItemAdded> eventEnvelope) {
        OrderItemTableItemAdded contractEvent = eventEnvelope.getParsedEventData().getValue();
        org.test.roochtestproj1.domain.order.OrderItemId id = new org.test.roochtestproj1.domain.order.OrderItemId(contractEvent.getOrderId(), contractEvent.getProductObjectId());
        org.test.roochtestproj1.rooch.contract.persistence.OrderItemTableItemAdded e = new org.test.roochtestproj1.rooch.contract.persistence.OrderItemTableItemAdded();
        e.setOrderItemId(id);
        setRoochEventProperties(e, eventEnvelope);
        return e;
    }

    public static org.test.roochtestproj1.rooch.contract.persistence.OrderShipGroupTableItemAdded toPersistenceOrderShipGroupTableItemAdded(AnnotatedEventView<OrderShipGroupTableItemAdded> eventEnvelope) {
        OrderShipGroupTableItemAdded contractEvent = eventEnvelope.getParsedEventData().getValue();
        org.test.roochtestproj1.domain.order.OrderShipGroupId id = new org.test.roochtestproj1.domain.order.OrderShipGroupId(contractEvent.getOrderId(), contractEvent.getShipGroupSeqId());
        org.test.roochtestproj1.rooch.contract.persistence.OrderShipGroupTableItemAdded e = new org.test.roochtestproj1.rooch.contract.persistence.OrderShipGroupTableItemAdded();
        e.setOrderShipGroupId(id);
        setRoochEventProperties(e, eventEnvelope);
        return e;
    }

    public static org.test.roochtestproj1.rooch.contract.persistence.OrderItemShipGroupAssociationTableItemAdded toPersistenceOrderItemShipGroupAssociationTableItemAdded(AnnotatedEventView<OrderItemShipGroupAssociationTableItemAdded> eventEnvelope) {
        OrderItemShipGroupAssociationTableItemAdded contractEvent = eventEnvelope.getParsedEventData().getValue();
        org.test.roochtestproj1.domain.order.OrderItemShipGroupAssociationId id = new org.test.roochtestproj1.domain.order.OrderItemShipGroupAssociationId(contractEvent.getOrderId(), contractEvent.getOrderShipGroupShipGroupSeqId(), contractEvent.getProductObjId());
        org.test.roochtestproj1.rooch.contract.persistence.OrderItemShipGroupAssociationTableItemAdded e = new org.test.roochtestproj1.rooch.contract.persistence.OrderItemShipGroupAssociationTableItemAdded();
        e.setOrderItemShipGroupAssociationId(id);
        setRoochEventProperties(e, eventEnvelope);
        return e;
    }

    public static org.test.roochtestproj1.rooch.contract.persistence.OrderItemShipGroupAssocSubitemTableItemAdded toPersistenceOrderItemShipGroupAssocSubitemTableItemAdded(AnnotatedEventView<OrderItemShipGroupAssocSubitemTableItemAdded> eventEnvelope) {
        OrderItemShipGroupAssocSubitemTableItemAdded contractEvent = eventEnvelope.getParsedEventData().getValue();
        org.test.roochtestproj1.domain.order.OrderItemShipGroupAssocSubitemId id = new org.test.roochtestproj1.domain.order.OrderItemShipGroupAssocSubitemId(contractEvent.getOrderId(), contractEvent.getOrderShipGroupShipGroupSeqId(), contractEvent.getOrderItemShipGroupAssociationProductObjId(), toDay(contractEvent.getOrderItemShipGroupAssocSubitemDay()));
        org.test.roochtestproj1.rooch.contract.persistence.OrderItemShipGroupAssocSubitemTableItemAdded e = new org.test.roochtestproj1.rooch.contract.persistence.OrderItemShipGroupAssocSubitemTableItemAdded();
