...
import org.test.roochtestproj1.domain.Day;
...
public class OrderItemShipGroupAssocSubitemEventId implements Serializable {
    ...
    public OrderItemShipGroupAssocSubitemEventId(String orderId, Integer orderShipGroupShipGroupSeqId, String orderItemShipGroupAssociationProductObjId, Day orderItemShipGroupAssocSubitemDay, BigInteger version)
    {
        this.orderId = orderId;
        this.orderShipGroupShipGroupSeqId = orderShipGroupShipGroupSeqId;
        this.orderItemShipGroupAssociationProductObjId = orderItemShipGroupAssociationProductObjId;
    ...
    public boolean equals(Object obj)
    {
        ...
        return true 
            ...
            && (orderItemShipGroupAssociationProductObjId == other.orderItemShipGroupAssociationProductObjId || (orderItemShipGroupAssociationProductObjId != null && orderItemShipGroupAssociationProductObjId.equals(other.orderItemShipGroupAssociationProductObjId)))
    ...
    public int hashCode()
    {
        ...
        if (this.orderItemShipGroupAssociationProductObjId != null) {
            hash += 13 * this.orderItemShipGroupAssociationProductObjId.hashCode();
        }
