...
public class OrderItemEventId implements Serializable {
    ...
    public OrderItemEventId(String orderId, String productObjectId, BigInteger version)
    {
        this.orderId = orderId;
        this.productObjectId = productObjectId;
        this.version = version;
    ...
    public boolean equals(Object obj)
    {
        ...
        return true 
            ...
            && (productObjectId == other.productObjectId || (productObjectId != null && productObjectId.equals(other.productObjectId)))
    ...
    public int hashCode()
    {
        ...
        if (this.productObjectId != null) {
            hash += 13 * this.productObjectId.hashCode();
        }
