...
package org.test.roochtestproj1.domain.meta;
...
public class M {
  ...
  public static class DaySummaryMetadata {
    ...
    public static final TextFormatter<org.test.roochtestproj1.domain.Day> URL_ID_TEXT_FORMATTER =
                    new AbstractValueObjectTextFormatter<org.test.roochtestproj1.domain.Day>(org.test.roochtestproj1.domain.Day.class, URL_ID_FIELD_SEPARATOR) {
                        @Override
    ...
    public static final Class ID_CLASS = org.test.roochtestproj1.domain.Day.class;
