...
import org.test.roochtestproj1.domain.order.OrderItemEvent.*;
...
public abstract class AbstractOrderItemState implements OrderItemState.SqlOrderItemState {
    ...
    public String getProductObjectId() {
        return this.getOrderItemId().getProductObjectId();
    }
        
    public void setProductObjectId(String productObjectId) {
        this.getOrderItemId().setProductObjectId(productObjectId);
    }
    ...
    @Override
    public int hashCode() {
        return getProductObjectId().hashCode();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof OrderItemState) {
            return Objects.equals(this.getProductObjectId(), ((OrderItemState)obj).getProductObjectId());
        }
        return false;
    }
    ...
    protected void throwOnWrongEvent(OrderItemEvent event) {
        ...
        String stateEntityIdProductObjectId = this.getOrderItemId().getProductObjectId();
        String eventEntityIdProductObjectId = ((OrderItemEvent.SqlOrderItemEvent)event).getOrderItemEventId().getProductObjectId();
        if (!stateEntityIdProductObjectId.equals(eventEntityIdProductObjectId)) {
            throw DomainError.named("mutateWrongEntity", "Entity Id ProductObjectId %1$s in state but entity id ProductObjectId %2$s in event", stateEntityIdProductObjectId, eventEntityIdProductObjectId);
        }
