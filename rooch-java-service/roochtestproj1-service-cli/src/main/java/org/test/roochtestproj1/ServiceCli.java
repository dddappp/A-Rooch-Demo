...
import org.test.roochtestproj1.tool.hibernate.SchemaTool;
...
public class ServiceCli {
    ...
    public static void main(final String[] args) throws Exception {
        /*
        sui-java-service % java -jar ./suiDemoContracts-service-cli/target/roochdemocontracts-service-cli-0.0.1-SNAPSHOT.jar ddl -d "./suiDemoContracts-service/src/generated/resources/scripts" -c "jdbc:mysql://127.0.0.1:3306/test2?enabledTLSProtocols=TLSv1.2&characterEncoding=utf8&serverTimezone=GMT%2b0&useLegacyDatetimeCode=false" -u root -p 123456
         */
        // //////////////////////////////////
