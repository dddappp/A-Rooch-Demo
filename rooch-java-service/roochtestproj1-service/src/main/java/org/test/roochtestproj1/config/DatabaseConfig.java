package org.test.roochtestproj1.config;

import org.test.roochtestproj1.specialization.NullReadOnlyProxyGenerator;
import org.test.roochtestproj1.specialization.ReadOnlyProxyGenerator;
...
//    }
    ...
    public LocalSessionFactoryBean hibernateSessionFactory() throws IOException {
        ...
        sessionFactory.setPackagesToScan("org.test.roochtestproj1.*"); //add annotation mappings
