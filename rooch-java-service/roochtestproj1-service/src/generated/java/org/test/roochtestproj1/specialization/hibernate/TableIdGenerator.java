package org.test.roochtestproj1.specialization.hibernate;

import org.test.roochtestproj1.specialization.ApplicationContext;
import org.test.roochtestproj1.specialization.IdGenerator;
...
public class TableIdGenerator<TCommand, TState> implements IdGenerator<Long, TCommand, TState> {
    ...
    private static final String DEFAULT_ROOT_ENTITY_NAME = "org.test.roochtestproj1.tool.hibernate.Hello";
