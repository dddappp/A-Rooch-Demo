module rooch_test_proj1::order_add_order_item_ship_group_assoc_subitem_logic {
    ...
    use rooch_test_proj1::order::{Self, OrderItemShipGroupAssocSubitemAdded};
    use rooch_test_proj1::order_item_ship_group_assoc_subitem;
    use rooch_test_proj1::order_item_ship_group_assoc_subitem_added;
    use rooch_test_proj1::order_item_ship_group_association;
    use rooch_test_proj1::order_ship_group;
