module rooch_test_proj1::day_summary_create_logic {
    ...
    use rooch_test_proj1::day_summary;
    use rooch_test_proj1::day_summary_created;

    friend rooch_test_proj1::day_summary_aggregate;
