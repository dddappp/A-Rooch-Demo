...
module rooch_test_proj1::day_summary {
    ...
    friend rooch_test_proj1::day_summary_create_logic;
    ...
    public(friend) fun asset_day_not_exists(
        ...
        let tables = account_storage::global_borrow<Tables>(storage_ctx, @rooch_test_proj1);
    ...
    fun asset_day_not_exists_then_add(
        ...
        let tables = account_storage::global_borrow_mut<Tables>(storage_ctx, @rooch_test_proj1);
