...
module rooch_test_proj1::order_item_ship_group_association {
    use moveos_std::object::ObjectID;
    use moveos_std::table::{Self, Table};
    use moveos_std::tx_context;
    use rooch_test_proj1::day::Day;
    use rooch_test_proj1::order_item_ship_group_assoc_subitem::{Self, OrderItemShipGroupAssocSubitem};
    ...
    friend rooch_test_proj1::order_ship_group;
